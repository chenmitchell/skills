...
// =============================================================================
// OpenClaw Plugin SDK types (inferred from actual SDK src/plugins/types.ts)
//
// These are declared here to avoid a hard dependency on openclaw internals.
// At runtime the plugin is loaded by OpenClaw which provides the real types.
// =============================================================================
